---
title: "[Docker Setup(Spring)] 1. 도커의 필요성과 WSL2 설치"
date: 2025-12-24
...
> - 실무에서 도커가 **선택이 아닌 필수**가 된 이유
> - 도커의 **핵심 개념(이미지, 컨테이너)**과 설치 방법
> - (Windows) `WSL2 & Docker Desktop` 설치 방법
...
![](/assets/img/posts/devops/docker/devops-docker-setup-1/devops-docker-setup-1-img-1.png)*[Docker and Container](https://stackoverflow.com/questions/23735149/what-is-the-difference-between-a-docker-image-and-a-container)*
...
![](/assets/img/posts/devops/docker/devops-docker-setup-1/devops-docker-setup-1-img-2.png)*[Docker and WSL2](https://forums.docker.com/t/is-there-a-pictorial-diagram-of-how-wsl-2-docker-docker-desktop-are-related/100071)*
