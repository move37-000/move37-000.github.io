...
![](/assets/img/2025-12-30/Docker_Setting(Spring)_3_img_1.png)*[Docker Layer](https://docs.docker.com/build/cache/)*

# 1. Spring Boot 프로젝트 빌드 (JAR 생성)

먼저 도커 이미지에 넣을 실행 파일(`.jar`)을 만들어야 합니다. 프로젝트 루트 경로에서 아래 명령어를 입력합니다. (`Gradle` 기준)
