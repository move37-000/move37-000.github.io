...
![](/assets/img/posts/project/concurrency-control/concurrency-control-6/concurrency-control-6-img-1.png)
...
**DLQ 처리 시도**
![](/assets/img/posts/project/concurrency-control/concurrency-control-6/concurrency-control-6-img-2.png)

- `DLQ Consumer`와 `Main Consumer`의 동시 동작 확인

**DLQ 최종 실패**
![](/assets/img/posts/project/concurrency-control/concurrency-control-6/concurrency-control-6-img-3.png)

- `DLQ Consumer` 에서도 강제 예외 처리로 인하여 최종 실패 발생
- 최종 실패 후 `Redis` **재고 원복과 발급 이력 롤백**

**DLQ 최종 실패 이력 저장**
![](/assets/img/posts/project/concurrency-control/concurrency-control-6/concurrency-control-6-img-4.png)
![](/assets/img/posts/project/concurrency-control/concurrency-control-6/concurrency-control-6-img-5.png)
